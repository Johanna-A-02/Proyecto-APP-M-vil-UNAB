...
public class profDetalle extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prof_detalle);
    }
    public void viewHistorialPof(View view) {
        //textView1.setText("FUNCIONA");
        switch (view.getId()){
            case R.id.btnBackEst:
            case R.id.btnHistoryEst:
                Intent intentHist=new Intent(profDetalle.this, ListadoProfes.class);
                startActivity(intentHist);
                break;

            case R.id.btnLogoutEst:
                Intent intentBack=new Intent(profDetalle.this, LoginActivity.class);
